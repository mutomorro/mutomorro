...
export default function EmergentFramework() {
  return (
    <main>
      ...
      <div className="de-page-container">
        ...
        {/* Header */}
        <div className="de-overview-kicker">A model of organisational health</div>
        <h1 className="de-overview-title">The EMERGENT Framework</h1>
