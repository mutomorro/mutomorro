  ...
  const dynamicEntries = [
    ...
    ...tools.map(t => ({
      ...
      images: collectImages(
        ...
        (t.bodyImages || []).map(b => bodySitemapImage('tool', t.slug, { imageSlug: b.imageSlug, alt: b.alt, key: b.key }, b.url)),
      ),
    })),
    ...
    ...articles.map(a => ({
      ...
      priority: 0.6,
      images: collectImages(
        sitemapImage('article', a.slug, a.heroImageUrl),
        (a.bodyImages || []).map(b => bodySitemapImage('article', a.slug, { imageSlug: b.imageSlug, alt: b.alt, key: b.key }, b.url)),
      ),
    })),
    ...projects.map(p => ({
