...
// All admin pages now consume these tokens via useAdminTheme().
// To add a new admin page, import { useAdminTheme } from '@/lib/admin-theme-context'
// and reference theme.cardBg, theme.textPrimary etc. — never hardcode colours.
...
export const themes = {
  dark: {
    ...
    success: '#2DD4BF',
    warning: '#D97706',
    warningStrong: '#FBBF24', // legible amber for text on dark surfaces
  ...
  light: {
    ...
    success: '#059669',
    warning: '#D97706',
    warningStrong: '#B45309', // darker amber for AA-legible text on light surfaces
