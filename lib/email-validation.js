...
// and returned by the download API routes. FREE_EMAIL_EMPHASIS is the phrase
// the forms render in bold; it must appear verbatim within the message.
export const FREE_EMAIL_EMPHASIS = 'organisational email address'

export const FREE_EMAIL_MESSAGE =
  "Please use an organisational email address - this helps us understand who's finding our tools useful"
