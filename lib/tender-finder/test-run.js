...
const doSendAlerts = args.includes('--send-alerts') || args.includes('--send-all')
...
console.log(`Notifications: digest=${doSendDigest}, alerts=${doSendAlerts}`)
