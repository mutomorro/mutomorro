...
const nextConfig = {
  ...
  async redirects() {
    const baseRedirects = [
      ...
      // =========================================================
      // CHAIN BREAKERS - direct paths for renamed slugs reached via legacy aliases
      // Without these, e.g. /sessions/<old> → /courses/<old> → /courses/<new> (2 hops).
      // These must precede the /article/:slug, /sessions/:slug, /training/:slug,
      // and /guides/:slug catch-alls further down.
      // =========================================================

      // Root-level tool slug at old domain (chain breaker for the-star-method)
      { source: '/the-star-method', destination: '/tools/star-method', permanent: true },
      ...
      // (Some specific /article/<old> redirects already exist further down; these
      // entries cover the remaining renamed slugs to break the catch-all chain.)
      { source: '/article/change-readiness', destination: '/articles/change-readiness-assessment', permanent: true },
      { source: '/guides/change-readiness', destination: '/articles/change-readiness-assessment', permanent: true },
      { source: '/article/the-change-readiness-imperative', destination: '/articles/change-fatigue-in-the-workplace', permanent: true },
      { source: '/guides/the-change-readiness-imperative', destination: '/articles/change-fatigue-in-the-workplace', permanent: true },
      { source: '/article/building-greater-organisational-resilience', destination: '/articles/building-organisational-resilience', permanent: true },
      { source: '/guides/building-greater-organisational-resilience', destination: '/articles/building-organisational-resilience', permanent: true },
      { source: '/article/writing-a-meaningful-mission-statement', destination: '/articles/how-to-write-a-mission-statement', permanent: true },
      { source: '/guides/writing-a-meaningful-mission-statement', destination: '/articles/how-to-write-a-mission-statement', permanent: true },
      { source: '/article/developing-a-need-for-change', destination: '/articles/building-the-case-for-change', permanent: true },
      { source: '/guides/developing-a-need-for-change', destination: '/articles/building-the-case-for-change', permanent: true },
      { source: '/article/developing-organisational-culture-the-basics', destination: '/articles/developing-organisational-culture', permanent: true },
      { source: '/guides/developing-organisational-culture-the-basics', destination: '/articles/developing-organisational-culture', permanent: true },
      { source: '/article/adaptive-leadership', destination: '/articles/adaptive-leadership-guide', permanent: true },
      { source: '/guides/adaptive-leadership', destination: '/articles/adaptive-leadership-guide', permanent: true },
      { source: '/article/nonprofit-mission-statement-guide', destination: '/articles/how-to-write-a-mission-statement', permanent: true },
      { source: '/guides/nonprofit-mission-statement-guide', destination: '/articles/how-to-write-a-mission-statement', permanent: true },
      { source: '/article/emotional-intelligence-in-leadership-guide', destination: '/articles/emotional-intelligence-for-leaders', permanent: true },
      { source: '/guides/emotional-intelligence-in-leadership-guide', destination: '/articles/emotional-intelligence-for-leaders', permanent: true },
      { source: '/article/nonprofit-resilience-guide', destination: '/articles/building-organisational-resilience', permanent: true },
      { source: '/guides/nonprofit-resilience-guide', destination: '/articles/building-organisational-resilience', permanent: true },
      { source: '/article/impact-measurement-framework-guide', destination: '/articles/impact-measurement-framework', permanent: true },
      { source: '/guides/impact-measurement-framework-guide', destination: '/articles/impact-measurement-framework', permanent: true },
      { source: '/article/designing-adaptive-organisational-architectures', destination: '/articles/adaptive-organisational-design', permanent: true },
      { source: '/guides/designing-adaptive-organisational-architectures', destination: '/articles/adaptive-organisational-design', permanent: true },
      { source: '/article/building-psychological-safety-a-guide-for-organisations', destination: '/articles/psychological-safety-in-organisations', permanent: true },
      { source: '/guides/building-psychological-safety-a-guide-for-organisations', destination: '/articles/psychological-safety-in-organisations', permanent: true },
      { source: '/article/organisational-culture-models', destination: '/articles/developing-organisational-culture', permanent: true },
      { source: '/guides/organisational-culture-models', destination: '/articles/developing-organisational-culture', permanent: true },
      { source: '/article/organisational-culture-guide', destination: '/articles/developing-organisational-culture', permanent: true },
      { source: '/guides/organisational-culture-guide', destination: '/articles/developing-organisational-culture', permanent: true },
      { source: '/article/defining-the-need-for-change', destination: '/articles/building-the-case-for-change', permanent: true },
      { source: '/guides/defining-the-need-for-change', destination: '/articles/building-the-case-for-change', permanent: true },
      { source: '/article/a-guide-to-change-readiness', destination: '/articles/change-readiness-assessment', permanent: true },
      { source: '/guides/a-guide-to-change-readiness', destination: '/articles/change-readiness-assessment', permanent: true },
      { source: '/article/addressing-change-fatigue', destination: '/articles/change-fatigue-in-the-workplace', permanent: true },
      { source: '/guides/addressing-change-fatigue', destination: '/articles/change-fatigue-in-the-workplace', permanent: true },
      { source: '/article/change-management-to-change-leadership', destination: '/articles/change-management-vs-change-leadership', permanent: true },
      { source: '/guides/change-management-to-change-leadership', destination: '/articles/change-management-vs-change-leadership', permanent: true },
      { source: '/article/writing-a-mission-statement', destination: '/articles/how-to-write-a-mission-statement', permanent: true },
      { source: '/guides/writing-a-mission-statement', destination: '/articles/how-to-write-a-mission-statement', permanent: true },
      { source: '/article/governance-the-enables-innovation', destination: '/articles/governance-that-enables-innovation', permanent: true },
      { source: '/guides/governance-the-enables-innovation', destination: '/articles/governance-that-enables-innovation', permanent: true },
      { source: '/article/strategic-planning-as-culture-development', destination: '/articles/culture-and-strategy-alignment', permanent: true },
      { source: '/guides/strategic-planning-as-culture-development', destination: '/articles/culture-and-strategy-alignment', permanent: true },
      // Article audit Batches 1-3 (lines further down) — break the same chains
      { source: '/article/translating-purpose-from-boardroom-to-breakroom', destination: '/articles/embedding-organisational-purpose', permanent: true },
      { source: '/guides/translating-purpose-from-boardroom-to-breakroom', destination: '/articles/embedding-organisational-purpose', permanent: true },
      { source: '/article/need-for-change', destination: '/articles/building-the-case-for-change', permanent: true },
      { source: '/guides/need-for-change', destination: '/articles/building-the-case-for-change', permanent: true },
      { source: '/article/the-friction-audit', destination: '/articles/reducing-organisational-friction', permanent: true },
      { source: '/guides/the-friction-audit', destination: '/articles/reducing-organisational-friction', permanent: true },
      { source: '/article/emotional-intelligence-in-leadership', destination: '/articles/emotional-intelligence-for-leaders', permanent: true },
      { source: '/guides/emotional-intelligence-in-leadership', destination: '/articles/emotional-intelligence-for-leaders', permanent: true },
      { source: '/article/guide-to-adaptive-leadership', destination: '/articles/adaptive-leadership-guide', permanent: true },
      { source: '/guides/guide-to-adaptive-leadership', destination: '/articles/adaptive-leadership-guide', permanent: true },
      { source: '/article/adaptive-organisational-architectures', destination: '/articles/adaptive-organisational-design', permanent: true },
      { source: '/guides/adaptive-organisational-architectures', destination: '/articles/adaptive-organisational-design', permanent: true },
      { source: '/article/build-impact-measurement-framework', destination: '/articles/impact-measurement-framework', permanent: true },
      { source: '/guides/build-impact-measurement-framework', destination: '/articles/impact-measurement-framework', permanent: true },
      // Retired CM cluster (May 2026)
      { source: '/article/storytelling-with-data', destination: '/articles/storytelling-and-organisational-change', permanent: true },
      { source: '/guides/storytelling-with-data', destination: '/articles/storytelling-and-organisational-change', permanent: true },
      { source: '/article/storytelling-for-social-change', destination: '/articles/storytelling-and-organisational-change', permanent: true },
      { source: '/guides/storytelling-for-social-change', destination: '/articles/storytelling-and-organisational-change', permanent: true },
      ...
      // /the-star-method now handled by the chain breaker near the top of this file
...
{ source: '/assessments/:slug', destination: '/states-of-vitality', permanent: true },
      ...
      // =========================================================
      // 2 May 2026 - trailing slash switch + GSC 404 sweep
      // =========================================================

      // Old WordPress sitemap files
      { source: '/sitemap_index.xml', destination: '/sitemap.xml', permanent: true },
      { source: '/wp-sitemap.xml', destination: '/sitemap.xml', permanent: true },

      // Old WordPress taxonomy (/category, /tag, /author)
      // Pagination must come before the catch-all
      { source: '/category/:slug/page/:num', destination: '/articles', permanent: true },
      { source: '/category/:slug', destination: '/articles', permanent: true },
      { source: '/tag/:slug', destination: '/tools', permanent: true },
      ...
      // Old WordPress assets
      { source: '/wp-content/:path*', destination: '/', permanent: true },

      // Misc one-off 404s from GSC sweep
      { source: '/holding', destination: '/', permanent: true },
      { source: '/tickets-checkout', destination: '/contact', permanent: true },
      { source: '/icai-planning-performance-tool', destination: '/tools', permanent: true },
      { source: '/service-test', destination: '/services', permanent: true },
    ...
    // with or without a trailing slash are caught. Next's path-to-regexp is
    // strict by default, and with `trailingSlash: false` it won't normalise
    // unknown URLs, so we have to match both forms explicitly.
    const seen = new Set()
    const expanded = []
    for (const r of baseRedirects) {
      ...
      const alt = r.source.endsWith('/')
        ? r.source.slice(0, -1)
        : r.source + '/'
      if (alt && alt !== '/' && !seen.has(alt)) {
        seen.add(alt)
        expanded.push({ ...r, source: alt })
      }
    }
    return expanded
  },
